...
import endpoints.RequestUsingProp;
import endpoints.Requests;
import io.restassured.response.Response;
import payload.User;

public class TestUsingPropFile {
	...
	public void postUser() {
		...
		Response response = RequestUsingProp.createUser(userPayload);
	...
	public void testGetUserByName() {
		...
		Response response = RequestUsingProp.getUser(userPayload.getUsername());
	...
	public void testUpdateUserByName() {
		...
		Response response = RequestUsingProp.updateUser(this.userPayload.getUsername(), userPayload);
		...
		Response responseAfterUpdate = RequestUsingProp.getUser(this.userPayload.getUsername());
	...
	public void testDeleteUserByName() {
		Response response = RequestUsingProp.deleteUser(this.userPayload.getUsername());
		Assert.assertEquals(response.getStatusCode(), 200);
	}
